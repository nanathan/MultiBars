...
MULTIBARS_BUFF_FOOD_ITEMS = {
	[11950] = true, -- Windblossom Berries
	[13813] = true, -- Blessed Sunfruit Juice
	[19318] = true, -- Bottled Alterac Spring Water
	[23176] = true, -- Fizzy Energy Drink
	
	[21151] = true, -- Rumsey Rum Black Label
	[21114] = true, -- Rumsey Rum Dark
	[20709] = true, -- Rumsey Rum Light
	[11584] = true, -- Cactus Apple Surprise
	[7806] = true, -- Lollipop
	[7807] = true, -- Candy Bar
	[7808] = true, -- Chocolate Square
	[5472] = true, -- Kaldorei Spider Kabob
	[6888] = true, -- Herb Baked Egg
	[17197] = true, -- Gingerbread Cookie
	[2680] = true, -- Spiced Wolf Meat
	[12224] = true, -- Crispy Bat Wing
	[2888] = true, -- Beer Basted Boar Ribs
	[17199] = true, -- Bad Egg Nog
	[17198] = true, -- Egg Nog
	[5474] = true, -- Roasted Kodo Meat
	[5476] = true, -- Fillet of Frenzy
	[3220] = true, -- Blood Sausage
	[5525] = true, -- Boiled Clams
	[724] = true, -- Goretusk Liver Pie
	[2684] = true, -- Coyote Steak
	[2683] = true, -- Crab Cake
	[3662] = true, -- Crocolisk Steak
	[2687] = true, -- Dry Pork Ribs
	[5477] = true, -- Strider Stew
	[5342] = true, -- Raptor Punch
	[1082] = true, -- Redridge Goulash
	[21072] = true, -- Smoked Sagefish
	[5479] = true, -- Crispy Lizard Tail
	[12209] = true, -- Lean Wolf Steak
	[5527] = true, -- Goblin Deviled Clams
	[3665] = true, -- Curiously Tasty Omelet
	[1017] = true, -- Seasoned Wolf Kabob
	[3726] = true, -- Big Bear Steak
	[3663] = true, -- Murloc Fin Soup
	[3664] = true, -- Crocolisk Gumbo
	[3727] = true, -- Hot Lion Chops
	[3666] = true, -- Gooey Spider Cake
	[5480] = true, -- Lean Venison
	[3728] = true, -- Tasty Lion Steak
	[20074] = true, -- Heavy Crocolisk Stew
	[4457] = true, -- Barbecued Buzzard Wing
	[12210] = true, -- Roast Raptor
	[13851] = true, -- Hot Wolf Ribs
	[12214] = true, -- Mystery Stew
	[12213] = true, -- Carrion Surprise
	[3729] = true, -- Soothing Turtle Bisque
	[12212] = true, -- Jungle Stew
	[12211] = true, -- Spiced Wolf Ribs
	[6038] = true, -- Giant Clam Scorcho
	[12217] = true, -- Dragonbreath Chili
	[21217] = true, -- Sagefish Delight
	[17222] = true, -- Spider Sausage
	[12215] = true, -- Heavy Kodo Stew
	[13931] = true, -- Nightfin Soup
	[13928] = true, -- Grilled Squid
	[12218] = true, -- Monster Omelet
	[16971] = true, -- Clamlette Surprise
	[18045] = true, -- Tender Wolf Steak
	...
	[20516] = true, -- Bobbing Apple
	[21023] = true, -- Dirge's Kickin' Chimaerok Chops
}

MULTIBARS_FOOD_ITEMS = {
	[6458] = true, -- Oil Covered Fish
	[5845] = true, -- Flank of Meat
	[17405] = true, -- Green Garden Tea
	[19997] = true, -- Harvest Nectar
	[20388] = true, -- Lollipop
	[20389] = true, -- Candy Corn
	[20390] = true, -- Candy Bar
	[21241] = true, -- Winter Veil Eggnog
...
MULTIBARS_CLASS_BARS = {
	...
	MultiBarBlessing = {
		...
		spells = {
			...
			{name = "Blessing of Kings", alternate = "Greater Blessing of Kings" },
			{name = "Blessing of Light", alternate = "Greater Blessing of Light" },
			{name = "Blessing of Might", alternate = "Greater Blessing of Might" },
			{name = "Blessing of Protection" },
			{name = "Blessing of Sacrifice" },
			{name = "Blessing of Salvation", alternate = "Greater Blessing of Salvation" },
			{name = "Blessing of Sanctuary", alternate = "Greater Blessing of Sanctuary" },
			{name = "Blessing of Wisdom", alternate = "Greater Blessing of Wisdom" },
		},
	},
	MultiBarCurse = {
		class = "WARLOCK",
	...
	MultiBarHunterPet = {
		...
		spells = {
			{name = "Beast Training"},
			{name = "Call Pet", noPet = true},
			{name = "Dismiss Pet", requiresPet = true},
			{name = "Eyes of the Beast", requiresPet = true},
			{name = "Feed Pet", requiresPet = true},
			{name = "Mend Pet", requiresPet = true},
			{name = "Revive Pet"},
			{name = "Tame Beast", noPet},
		},
	},
	MultiBarMageArmor = {
		class = "MAGE",
	...
	MultiBarPriest = {
		...
		hasAlternates = true,
		spells = {
			{name = "Divine Spirit", alternate = "Prayer of Spirit" },
			{name = "Fear Ward" },
			{name = "Inner Fire" },
			{name = "Power Word: Fortitude", alternate = "Prayer of Fortitude" },
			{name = "Shadow Protection", alternate = "Prayer of Shadow Protection" },
		},
	},
	MultiBarSeal = {
		class = "PALADIN",
